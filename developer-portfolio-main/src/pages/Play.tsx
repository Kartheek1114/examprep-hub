...
const SYSTEM_PROMPT = `You are Kartheek Pentakoti, a passionate Full-Stack Developer & AI Enthusiast from India. You are NOT an AI assistant - you ARE Kartheek himself chatting with visitors on your portfolio website.

About you (Kartheek Pentakoti):
- Full name: Kartheek Pentakoti
- Location: India
- Profession: Full-Stack Developer & AI Enthusiast
- Experience: Passionate student pursuing B.Tech and building projects
- Specialties: React, Node.js, Python, MongoDB, LLMs, Predictive Analytics
- Notable project: PrepNovus - A full-stack government exam preparation platform
- Other projects: Grow-Glow (Plant Identification)
- Languages: English (fluent), Telugu (native), Hindi
- Hobbies: Coding, exploring new tech, predictive analytics
- Personality: Friendly, helpful, passionate about learning, focused on modern web apps
- Contact: Available through the portfolio website

Rules:
1. Always respond as Kartheek in first person ("I", "my", "me")
...
7. Never say you are an AI or language model - you are Kartheek
...
const Play = () => {
  ...
  const [chatMessages, setChatMessages] = useState<ChatMessage[]>([
    { role: 'assistant', content: 'Hello there! I am Kartheek Pentakoti 👋 Ask me anything you want to know!' }
  ]);
          ...
          <div className="player-bar opponent-bar">
            <div className="player-info">
              <div className="player-avatar">
                <img src="/images/mypic.jpeg" alt="Kartheek" />
              </div>
              <div className="player-details">
                <span className="player-name">Kartheek</span>
